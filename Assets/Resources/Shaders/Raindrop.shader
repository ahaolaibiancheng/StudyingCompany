Shader "Custom/RaindropEffect"
{
    // Properties
    // {
    //     _MainTex ("Base Texture", 2D) = "white" {}
    //     _RainDropTex ("Rain Drop Texture", 2D) = "white" {}
    //     _DistortionTex ("Distortion Texture", 2D) = "bump" {}
    //     _RainIntensity ("Rain Intensity", Range(0, 1)) = 0
    //     _DropSpeed ("Drop Speed", Float) = 1.0
    //     _DropSize ("Drop Size", Float) = 1.0
    ...
    Properties
    {
        ...
        _Time2("雨滴下落速度", Range(0,1)) = 0 
        _DropAmount("动态雨滴数量",Range(2,5)) = 0 
        _StaticAmount("静态雨滴数量", Range(0.5,5)) =0
        _Blur("背景模糊", Range(0,1)) = 0 
        [Space (20)] 
        [KeywordEnum(Cheap_normals, Expensive_normals)]_normalType("法线型",Float) = 0
